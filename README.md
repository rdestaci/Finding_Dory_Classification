...
The stimuli used in this analysis are lines of dialogue from the script of *Finding Dory* obtained from [Kaggle](https://www.kaggle.com/datasets/ashtrindade/finding-dory-movie-script). For simplicity, the script is filtered to only include the top ten characters that have the most lines, then tokenized using `nltk`. 
